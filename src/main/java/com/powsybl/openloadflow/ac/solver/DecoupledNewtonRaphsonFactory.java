...
public class DecoupledNewtonRaphsonFactory implements AcSolverFactory {

    public static final String NAME = "DECOUPLED_NEWTON_RAPHSON";
    ...
    public AcSolver create(LfNetwork network, AcLoadFlowParameters parameters, EquationSystem<AcVariableType, AcEquationType> equationSystem,
        ...
        return new DecoupledNewtonRaphson(network, (NewtonRaphsonParameters) parameters.getAcSolverParameters(), equationSystem, j, targetVector, equationVector, parameters.isDetailedReport());
    }
