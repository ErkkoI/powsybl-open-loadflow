 ...
 */
public class DecoupledNewtonRaphson extends AbstractAcSolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(DecoupledNewtonRaphson.class);
    ...
    public String getName() {
        return "Decoupled Newton Raphson";
    }
    ...
    private AcSolverStatus runIteration(StateVectorScaling svScaling, MutableInt iterations, ReportNode reportNode) {
        ...
        try {
            ...
            if (detailedReport && iterationReportNode != null) {
